...
export const MissionSuccessScreen: React.FC<MissionSuccessScreenProps> = ({ state, onReturn }) => {
        ...
        <div className="absolute inset-0 z-50 bg-slate-950 flex flex-col items-center justify-center pointer-events-auto font-mono overflow-hidden">
             ...
             <div className="relative z-10 w-[800px] border-y-4 border-emerald-500 bg-slate-900/90 p-12 shadow-[0_0_100px_rgba(16,185,129,0.4)] flex flex-col items-center text-center backdrop-blur-md">
                 ...
                 <div className="w-full bg-emerald-900/30 border border-emerald-500/50 p-2 mb-8 flex justify-between items-center">
                     <span className="text-emerald-400 font-bold tracking-[0.2em] text-xs">UPLINK ESTABLISHED</span>
                     <span className="text-emerald-400 font-bold tracking-[0.2em] text-xs">PROTOCOL 10-ZULU</span>
                 </div>

                 <h1 className="text-6xl font-black text-white tracking-tighter mb-2 drop-shadow-[0_0_15px_rgba(52,211,153,0.8)]">SECTOR PACIFIED</h1>
                 <h2 className="text-xl text-emerald-500 font-bold tracking-widest mb-12">MISSION OBJECTIVES <span className="text-white bg-emerald-600 px-2 py-0.5 text-sm ml-2 rounded">COMPLETE</span></h2>
                 ...
                 <div className="w-full grid grid-cols-2 gap-8 mb-12">
                     ...
                     <div className="bg-black/40 border border-emerald-900/50 p-6 flex flex-col justify-center items-center relative overflow-hidden group">
                         ...
                         <div className="text-xs text-emerald-600 font-bold uppercase tracking-widest mb-2">RESOURCES SECURED</div>
                         ...
                         <div className="text-[10px] text-yellow-600 mt-1">MOLECULAR SCRAPS TRANSFER COMPLETE</div>
                     </div>
                     ...
                     <div className="flex flex-col gap-4">
                         <div className="flex-1 bg-black/40 border border-emerald-900/50 p-4 flex justify-between items-center px-8">
                             <div className="text-left">
                                 <div className="text-xs text-emerald-600 font-bold uppercase">HOSTILES NEUTRALIZED</div>
                         ...
                         <div className="flex-1 bg-black/40 border border-emerald-900/50 p-4 flex justify-between items-center px-8">
                             <div className="text-left">
                                 <div className="text-xs text-emerald-600 font-bold uppercase">BASE INTEGRITY</div>
                 ...
                 <p className="text-slate-400 text-xs mb-8 max-w-md border-t border-emerald-900/30 pt-4">
                     All local resistance has been eliminated. The area is secure for automated mining drones. Prepare for orbital extraction and debriefing.
                 </p>
                 ...
                 >
                     ...
                     <div className="relative flex items-center gap-4">
                         <span className="text-emerald-100 font-black tracking-[0.2em] text-xl">INITIATE ASCENT</span>
