...
export const FAMOUS_SECTORS: SectorPreset[] = [
    {
        ...
        planets: [
            ...
            { name: "Ganymede", biome: BiomeType.BARREN, visualType: PlanetVisualType.ICE, missionType: MissionType.DEFENSE, geneStrength: 1.7, sulfurIndex: 1, landingDifficulty: 12, totalWaves: 18 },
            { name: "Callisto", biome: BiomeType.BARREN, visualType: PlanetVisualType.BARREN, missionType: MissionType.DEFENSE, geneStrength: 1.8, sulfurIndex: 2, landingDifficulty: 14, totalWaves: 20 }
        ]
    },
    {
        id: "ISHIMURA_WAKE",
        ...
        planets: [
            ...
            { name: "Deep Dig 3", biome: BiomeType.DESERT, visualType: PlanetVisualType.BARREN, missionType: MissionType.DEFENSE, geneStrength: 3.2, sulfurIndex: 8, landingDifficulty: 24, totalWaves: 42 },
            { name: "Ventilation Shaft", biome: BiomeType.BARREN, visualType: PlanetVisualType.BARREN, missionType: MissionType.DEFENSE, geneStrength: 2.7, sulfurIndex: 5, landingDifficulty: 18, totalWaves: 36 }
        ]
    },
    {
        id: "HELIX_NEBULA",
        ...
        planets: [
            ...
            { name: "Mutation Pit", biome: BiomeType.TOXIC, visualType: PlanetVisualType.TERRAN, missionType: MissionType.DEFENSE, geneStrength: 3.8, sulfurIndex: 8, landingDifficulty: 25, totalWaves: 32 }
        ]
    },
    {
        id: "VANGUARD_HUB",
    ...
    },
    {
        ...
        planets: [
            ...
            { name: "Scrap Yard", biome: BiomeType.DESERT, visualType: PlanetVisualType.BARREN, missionType: MissionType.DEFENSE, geneStrength: 2.2, sulfurIndex: 4, landingDifficulty: 16, totalWaves: 26 }
        ]
    },
    {
        id: "VOID_TERMINUS",
        ...
        planets: [
            ...
            { name: "Event Horizon", biome: BiomeType.BARREN, visualType: PlanetVisualType.GAS_GIANT, missionType: MissionType.OFFENSE, geneStrength: 5.0, sulfurIndex: 0, landingDifficulty: 30, totalWaves: 0 }
        ]
    }
];
